...
@model({settings: {postgresql: {schema: 'public', table: 'receivables'}}})
export class ReceivableModel extends Entity {
  ...
  constructor(data?: Partial<ReceivableModel>)  { super(); /* Inyectado por constructor */ }
}
